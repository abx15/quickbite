...
const Navbar = () => {
  return (
    <header className='bg-white fixed top-0 right-0 left-0'>
      ...
      <ul className="flex flex-col gap-y-6 bg-orange-500 p-8 items-center md:hidden absolute top-[80px] left-1/2 transform -translate-x-1/2 w-[90%] rounded-lg shadow-lg">
  <li>
